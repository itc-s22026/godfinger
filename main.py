...
class Game:
    ...
    def __init__(self):
        ...
        self.canvas = Canvas(self.tk, width=700, height=600, bd=False, highlightthickness=False)
        self.canvas.pack()      
        self.tk.update()        
        ...
        self.ball = Ball(self.canvas, "red", self.paddle, self.block)
        ...
        self.canvas.bind_all("<KeyPress-Down>", self.block.start)
